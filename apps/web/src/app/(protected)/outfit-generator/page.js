...
export default function OutfitGeneratorPage() {
  ...
  const removeCategory = (categoryName) => {
    setCategories(categories.filter((a) => a != categoryName));
  };
  const parentSetSelectedCallback = (selectedClosetItemId) => {
    console.log(selectedClosetItemId);
  };
